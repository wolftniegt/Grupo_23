...
formularioMascota.addEventListener('submit', (event) => {
    ...
    const datosMascota = {  //definiendo un objeto
        ...
        nombreMascota: document.getElementById('nombre-paciente').value,
        nombreDueño: document.getElementById('apellido-paciente').value,
        cedulaDueño: document.getElementById('cedula-paciente').value,
        edadMascota: document.getElementById('edad-paciente').value,
        telefonoDueño: document.getElementById('telefono-paciente').value,
        especialidad: document.getElementById('especialidad').value,
    };
    guardarEnCookie(datosMascota)
    const confirmacion = confirm('¿Desea ver los datos o seguir añadiendo pacientes?');
    if (confirmacion) {
        window.location.href = 'mostrar-pacientes.html';
    } else {
